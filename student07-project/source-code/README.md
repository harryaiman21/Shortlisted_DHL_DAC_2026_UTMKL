Youtube demo video link: https://youtu.be/PL2V2sOGm5w
...
UiPath is used to automate file uploads.
...
1. UiPath reads files (PDF, DOCX, TXT, images)
2. Sends files to backend API
3. Backend extracts text
4. AI (Phi-3) processes content
5. Structured article saved in MySQL
